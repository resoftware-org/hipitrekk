...
});" id="switchPlansModal" x-show="$store.plan_modal.open"
    class="fixed inset-0 z-50 overflow-y-auto" x-cloak>
    <div class="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
        <div x-show="$store.plan_modal.open" x-on:click="$store.plan_modal.close()"
        ...
        <div x-show="open" x-transition:enter="ease-out duration-300"
            ...
            <div class="mt-2 flex w-full flex-col justify-between">
                <div class="flex flex-col items-center">
                    <div
                        class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-center">
                    ...
                    <div class="mt-3 text-center sm:ml-4">
                        ...
                        <div class="mt-1">
                            <p class="text-sm leading-5 text-zinc-500">Are you sure you want to switch to the <span
                                    x-text="plan_name"></span> plan?</p>
                        </div>
                    </div>
                </div>
