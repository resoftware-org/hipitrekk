    ...
    <x-container>
        <div class="relative z-30 flex h-24 items-center justify-between md:space-x-8">
            <div class="inline-flex">
                ...
                <a href="{{ route('home') }}"
                    class="grayscale-100 flex transform items-center justify-center space-x-3 text-blue-500 brightness-0 transition-all duration-300 ease-out hover:brightness-100">
                    <x-logo class="h-7 w-auto"></x-logo>
                </a>
            </div>
            <div class="-my-2 -mr-2 flex flex-grow justify-end md:hidden">
                <button @click="mobileMenuOpen = true" type="button"
                    class="inline-flex items-center justify-center rounded-full p-2 text-zinc-400 transition duration-150 ease-in-out hover:bg-zinc-100 hover:text-zinc-500 focus:bg-zinc-100 focus:text-zinc-500 focus:outline-none">
