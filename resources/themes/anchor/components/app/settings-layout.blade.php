<x-card class="mx-auto flex w-full max-w-4xl flex-col lg:my-10">
    <div class="sm:flex-no-wrap mt-5 flex flex-wrap items-center justify-between border-b border-zinc-200 pb-3 dark:border-zinc-800 sm:mt-8 lg:mt-0">
    ...
    <div class="flex flex-col pt-5 lg:flex-row lg:space-x-8">
        <aside class="flex-shrink-0 pb-8 lg:w-48 lg:pb-0 lg:pt-4">
            <nav class="flex items-start justify-start lg:flex-col lg:space-y-1">
                ...
                <div class="flex w-auto items-center space-x-2 lg:w-full lg:flex-col lg:items-stretch lg:space-x-0 lg:space-y-1">
                ...
                <div class="ml-2 flex w-full items-center space-x-2 lg:ml-0 lg:flex-col lg:items-stretch lg:space-x-0 lg:space-y-1">
