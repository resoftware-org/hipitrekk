        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    ...
                    <x-app.sidebar-link href="#" icon="phosphor-cube" :active="(Request::is('map'))">View Map</x-app.sidebar-link>
                    <x-app.sidebar-link href="#" icon="phosphor-compass" :active="(Request::is('map.compass'))">Compass</x-app.sidebar-link>
                    <x-app.sidebar-link href="#" icon="phosphor-line-segments" :active="(Request::is('planner'))">Route planner</x-app.sidebar-link>
            ...
            <div class="relative px-2.5 space-y-1.5 text-zinc-700 dark:text-zinc-400">
                ...
                <div x-show="sidebarTip" x-data="{ sidebarTip: $persist(true) }" class="px-1 py-3" x-collapse x-cloak>
                    <div class="relative w-full px-4 py-3 space-y-1 border rounded-lg bg-zinc-50 text-zinc-700 dark:text-zinc-100 dark:bg-zinc-800 border-zinc-200/60 dark:border-zinc-700">
                        ...
                        <h5 class="pb-1 text-sm font-bold -translate-y-0.5">Under development</h5>
                        <p class="block pb-1 text-xs opacity-80 text-balance">App: <em>{{ config('app.url') }}</em></p>
                        <p class="block pb-1 text-xs opacity-80 text-balance">App version: <x-version /></p>
                    </div>
                </div>
