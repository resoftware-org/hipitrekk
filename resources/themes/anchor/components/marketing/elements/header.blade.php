...
window.addEventListener('scroll', function() {
    ...
    <div x-show="showOverlay" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="absolute inset-0 h-screen w-full pt-24" x-cloak>
        ...
        <div class="z-30 flex h-24 items-center justify-between md:space-x-8">
            <div class="z-20 flex w-full items-center justify-between md:w-auto">
                ...
                <div class="flex flex-grow justify-end md:hidden">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" type="button" class="inline-flex items-center justify-center rounded-full p-2 text-zinc-400 transition duration-150 ease-in-out hover:bg-zinc-100 hover:text-zinc-500">
                        <svg x-show="!mobileMenuOpen" class="h-6 w-6" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16M4 16h16">
                            </path>
                        </svg>
                        <svg x-show="mobileMenuOpen" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <nav :class="{
                ...
                <ul :class="{
                            ...
                            <ul class="mx-auto flex max-w-7xl flex-col justify-between md:flex-row md:px-16">
                                <li class="w-full border-l border-gray-100 md:w-1/5">
                                    <a href="#_" onclick="demoButtonClickMessage(event)" class="block h-full p-6 text-lg font-semibold hover:bg-gray-50 lg:p-7 lg:py-10">
                                        <img src="/wave/img/icons/anchor.png" class="h-auto w-12" alt="feature 1 icon" />
                                ...
                                <li class="w-full border-l border-gray-100 md:w-1/5">
                                    <a href="#_" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button in your theme folder').icon('heroicon-o-pencil-square').iconColor('info').send()"
                                        class="block h-full p-6 text-lg font-semibold hover:bg-gray-50 lg:p-7 lg:py-10">
                                        <img src="/wave/img/icons/turtle.png" class="h-auto w-12" alt="feature 2 icon" />
                                        <span class="my-2 block text-xs font-bold uppercase text-slate-800">Feature
                                            Two</span>
                                ...
                                <li class="w-full border-l border-gray-100 md:w-1/5">
                                    <a href="#_" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button in your theme folder').icon('heroicon-o-pencil-square').iconColor('info').send()"
                                        class="block h-full p-6 text-lg font-semibold hover:bg-gray-50 lg:p-7 lg:py-10">
                                        <img src="/wave/img/icons/compass.png" class="h-auto w-12" alt="feature 3 icon" />
                                        <span class="my-2 block text-xs font-bold uppercase text-slate-800">Feature
                                            Three</span>
                                ...
                                <li class="w-full border-l border-gray-100 md:w-1/5">
                                    <a href="#_" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button in your theme folder').icon('heroicon-o-pencil-square').iconColor('info').send()"
                                        class="block h-full p-6 text-lg font-semibold hover:bg-gray-50 lg:p-7 lg:py-10">
                                        <img src="/wave/img/icons/lighthouse.png" class="h-auto w-12" alt="feature 4 icon" />
                                        <span class="my-2 block text-xs font-bold uppercase text-slate-800">Feature
                                            Four</span>
                    ...
                    <li x-data="{ open: false }" @mouseenter="showOverlay=true" @mouseleave="showOverlay=false" class="group z-30 flex h-auto flex-col items-start border-b border-gray-100 md:h-full md:flex-row md:items-center md:border-b-0">
                        ...
                        <div :class="{
                            ...
                            <ul class="mx-auto flex max-w-7xl flex-col justify-between md:flex-row md:px-12">
                                <div class="flex w-full flex-col divide-x divide-zinc-100 border-l border-r border-zinc-100 md:flex-row">
                                    <div class="w-auto divide-y divide-zinc-100">
                                        <a href="#_" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button in your theme folder').icon('heroicon-o-pencil-square').iconColor('info').send()" class="group block p-7 text-sm hover:bg-neutral-100">
                    ...
                    @guest
                        <li class="relative z-30 flex h-auto w-full flex-shrink-0 flex-col items-center justify-center space-y-3 px-7 pt-3 text-sm md:hidden">
            ...
            @else
                <x-button href="{{ route('login') }}" tag="a" class="text-sm" class="relative z-20 ml-2 hidden flex-shrink-0 md:block">View Dashboard</x-button>
            @endguest
